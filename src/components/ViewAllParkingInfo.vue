<template>
  <div>
      ...
      >
        ...
        <div class="d-flex align-center ml-2" style="gap: 20px">
          ...
          <img
            ...
            height="35"
          />
          <h3>Parking Info ( <span class="text-red">12</span> )</h3>
        </div>
      </div>
      <div
    ...
    <v-container style="padding-top: 180px; padding-bottom: 50px">
      <v-sheet elevation="0">
        <v-row
          dense
    ...
    >
      <p>
        <span class="text-red">4</span> Parking in
...
export default {
  ...
  methods: {
    goToDetail(item) {
      ...
      this.$router.push(`/parking-info-id/${item.id}`);
    },
    selectTag(tag) {
      this.activeTag = tag;
    },
