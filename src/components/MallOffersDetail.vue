<template>
  <div>
    <div style="z-index: 1000" class="position-fixed w-100">
      ...
      <div
        class="card-title-container mt-n2 d-flex justify-space-between align-center px-1 pb-2 pt-2 w-100 bg-white"
      >
        <div class="w-25">
    ...
    <v-container style="padding-top: 230px; padding-bottom: 10px">
      <div class="py-4" style="border-bottom: 1px solid lightgrey">
        <h4>More Time to Shop & Dine with us!</h4>
        <p style="font-size: 12px">
          Making sure that you have every chance to shop and dine with us
          safely. we have extended your points earned in 2020 to 30 Sep 2021.
        </p>

        <div class="d-flex flex-column mt-6" style="gap: 20px; font-size: 12px">
          <div class="d-flex justify-space-between">
            <div class="card-time d-flex align-center" style="gap: 10px">
      ...
      <div class="py-4">
        <h3>Other Mall Offers</h3>
        <v-sheet elevation="0" class="mt-6">
          <v-row
            dense
